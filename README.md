...
* [Latest Stable Release](https://github.com/pkgforge-dev/Identity-AppImage/releases/latest)
...
* [AM](https://github.com/ivan-hc/AM) `am -i identity` or `appman -i identity`

* [dbin](https://github.com/xplshn/dbin) `dbin install identity.appimage`

* [soar](https://github.com/pkgforge/soar) `soar install identity`
